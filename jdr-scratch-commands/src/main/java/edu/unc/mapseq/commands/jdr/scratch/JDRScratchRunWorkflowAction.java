...
@Command(scope = "jdr-scratch", name = "run-workflow", description = "Run JDR Scratch Workflow")
public class JDRScratchRunWorkflowAction extends AbstractAction {
    ...
    public JDRScratchRunWorkflowAction() {
        super();
    }
