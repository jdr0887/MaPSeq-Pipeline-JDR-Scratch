...
public class JDRScratchWorkflowMessageListener extends AbstractMessageListener {

    private final Logger logger = LoggerFactory.getLogger(JDRScratchWorkflowMessageListener.class);

    public JDRScratchWorkflowMessageListener() {
        super();
    }
